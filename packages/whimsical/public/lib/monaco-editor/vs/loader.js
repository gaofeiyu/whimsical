        ...
        return (
          this.PERFORMANCE_NOW_PROBED ||
            ...
            (this.HAS_PERFORMANCE_NOW =
              f.global.performance && typeof f.global.performance.now == 'function')),
        ...
        if (!f.Utilities.endsWith(r, '.js') && !f.Utilities.isAbsolutePath(r)) {
          ...
          for (var t = 0, i = e.length; t < i; t++)
            (this.isBuild() && e[t] === 'empty:') ||
              (f.Utilities.isAbsolutePath(e[t]) || (e[t] = this.options.baseUrl + e[t]),
              !f.Utilities.endsWith(e[t], '.js') &&
                !f.Utilities.containsQueryString(e[t]) &&
                (e[t] = e[t] + '.js'));
        } else
          !f.Utilities.endsWith(r, '.js') && !f.Utilities.containsQueryString(r) && (r = r + '.js'),
            (e = [r]);
      ...
      return (
        ...
        (r.prototype._initNodeRequire = function (e, t) {
          ...
          u.prototype._compile = function (l, c) {
            ...
            return (
              o._handleCachedData(b, d, _, !y.cachedData, t), o._verifyCachedData(b, d, _, m, t), R
            );
          };
        }),
        (r.prototype.load = function (e, t, i, o) {
        ...
        (r.prototype._createAndEvalScript = function (e, t, i, o, u) {
          ...
          return (
            ...
            v ? o() : u(new Error("Didn't receive define call in " + i.filename + '!')),
            l
          );
        }),
        ...
        (r.prototype._createAndWriteCachedData = function (e, t, i, o) {
          var u = this,
            s = Math.ceil(
              o.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random())
            ),
            l = -1,
            c = 0,
            d = void 0,
      ...
      (r.prototype.resolveModule = function (e) {
        ...
        return (
          f.Utilities.isAbsolutePath(t) ||
            ((f.Utilities.startsWith(t, './') || f.Utilities.startsWith(t, '../')) &&
  ...
  var h = (function () {
    ...
    return (
      ...
      (r.prototype.onDependencyError = function (e) {
        return (
          (this._isComplete = !0), (this.error = e), this._errorback ? (this._errorback(e), !0) : !1
        );
      }),
    ...
    return (
        ...
        for (var e = [], t = 0, i = 0, o = this._modules2.length; i < o; i++) {
          ...
          if (!!u) {
            ...
            e[t++] = {
              id: u.strId,
              path: s,
              defineLocation: s && l ? r._findRelevantLocationInStack(s, l) : null,
              dependencies: c,
              shim: null,
              exports: u.exports,
            };
        ...
        return (
          this._recorder ||
            (this._config.shouldRecordStats()
              ? (this._recorder = new f.LoaderEventRecorder(this._loaderAvailableTimestamp))
      ...
      (r.prototype.enqueueDefineAnonymousModule = function (e, t) {
        ...
        this._config.isBuild() && (i = new Error('StackLocation').stack || null),
          (this._currentAnnonymousDefineCall = { stack: i, dependencies: e, callback: t });
      }),
...
`)
            ...
            if (
              ((this._inverseDependencies2[s.id] = this._inverseDependencies2[s.id] || []),
              ...
              v || ((v = []), this._inversePluginDependencies2.set(s.pluginId, v)),
                v.push(s),
