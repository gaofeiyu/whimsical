...
!(function (e) {
  ...
  (function (e) {
    ...
    (t.format = function (e, t, i) {
      ...
      for (; 17 !== C; ) {
        for (
          var A = g.getTokenOffset() + g.getTokenLength() + c, T = b(), k = '', O = !1;
          !h && (12 === T || 13 === T);
            ...
            return (function () {
              ...
              for (var e = !1; 2 !== i.getToken() && 17 !== i.getToken(); ) {
                ...
                (10 !== i.getToken()
                  ? (x(3, [], [2, 5]), 0)
                  : (S(!1),
                    6 === i.getToken() ? (h(':'), b(), C() || x(4, [], [2, 5])) : x(5, [], [2, 5]),
                    1)) || x(4, [], [2, 5]),
                  (e = !0);
              }
  ...
  (function (e) {
    ...
    function o(e, t, n, o) {
      for (
        ...
        s.length > 0 &&
        ((f = s.pop()), void 0 === (u = r.findNodeAtLocation(c, s)) && void 0 !== n);
      ...
      if (u) {
        if ('object' === u.type && 'string' == typeof f && Array.isArray(u.children)) {
          ...
          if (void 0 !== l) {
            ...
            return i(e, { offset: l.offset, length: l.length, content: JSON.stringify(n) }, o);
          }
          if (void 0 === n) return [];
          ...
          return i(
            ...
            (g =
              (j = o.getInsertionIndex
                ...
                : u.children.length) > 0
                ? { offset: (C = u.children[j - 1]).offset + C.length, length: 0, content: ',' + m }
                : 0 === u.children.length
        ...
        (e.create = function (e, t, n, r) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (o.is(t.targetSelectionRange) || k.undefined(t.targetSelectionRange)) &&
              (o.is(t.originSelectionRange) || k.undefined(t.originSelectionRange))
            );
          });
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (k.undefined(t.additionalTextEdits) || k.typedArray(t.additionalTextEdits, f.is))
            );
          });
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              (k.undefined(n.codeDescription) ||
                k.string(null === (t = n.codeDescription) || void 0 === t ? void 0 : t.href)) &&
              (k.string(n.source) || k.undefined(n.source)) &&
              (k.undefined(n.relatedInformation) || k.typedArray(n.relatedInformation, s.is))
            );
          });
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              k.objectLiteral(t) &&
              k.string(t.label) &&
              (k.boolean(t.needsConfirmation) || void 0 === t.needsConfirmation) &&
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              k.string(t.uri) &&
              (void 0 === t.options ||
                ((void 0 === t.options.overwrite || k.boolean(t.options.overwrite)) &&
                  (void 0 === t.options.ignoreIfExists || k.boolean(t.options.ignoreIfExists)))) &&
        ...
        (e.create = function (e, t, n) {
          ...
          (e.is = function (e) {
            ...
            return (
              ...
              k.string(t.uri) &&
              (void 0 === t.options ||
                ((void 0 === t.options.recursive || k.boolean(t.options.recursive)) &&
      ...
      (function (e) {
        e.is = function (e) {
          ...
          return (
            !!t &&
            k.objectLiteral(t) &&
            (S.is(t.contents) || C.is(t.contents) || k.typedArray(t.contents, C.is)) &&
                  ...
                  if (r.isBoolean(x))
                    if (x) n.propertiesMatches++, n.propertiesValueMatches++;
                      ...
                      n.problems.push({
                        ...
                        message:
                          t.errorMessage ||
                          i('DisallowedExtraPropWarning', 'Property {0} is not allowed.', E),
                      });
                    }
            ...
            if ((C(c, f, l, d), l.hasProblems() || r.push(f), o))
              if (t || l.hasProblems() || o.validationResult.hasProblems()) {
                ...
                o.matchingSchemas.merge(d),
                  ...
                  (o.validationResult.propertiesValueMatches += l.propertiesValueMatches);
        ...
        return (
          ...
          (e.prototype.doComplete = function (e, t, r) {
            ...
            if (u && c === u.offset + u.length && c > 0) {
              var f = a[c - 1];
              (('object' === u.type && '}' === f) || ('array' === u.type && ']' === f)) &&
                (u = u.parent);
            }
            var l,
                ...
                if ('object' == typeof u && !u.deprecationMessage && !u.doNotSuggest) {
                  ...
                  if (u.enum)
                    for (var l = 0; l < u.enum.length; l++) {
                      var d = void 0;
                      u.markdownEnumDescriptions && l < u.markdownEnumDescriptions.length
          ...
          (e.prototype.getSchemaLessValueCompletions = function (e, t, r, o, i) {
            ...
            if ('property' === t.type && r > (t.colonOffset || 0)) {
              var l = t.valueNode;
              if (l && (r > l.offset + l.length || 'object' === l.type || 'array' === l.type))
                return;
              var d = t.keyNode.value;
              e.visit(function (e) {
                return (
                  'property' === e.type && e.keyNode.value === d && e.valueNode && f(e.valueNode),
                  !0
                );
              }),
                '$schema' === d &&
          ...
          (e.prototype.getValueCompletions = function (e, t, n, r, o, i, a) {
            ...
            if (
              ...
              if (n && (void 0 !== c || 'array' === n.type)) {
                ...
                '$schema' !== c || n.parent || this.addDollarSchemaCompletions(l, i),
                  a.boolean &&
              ...
              p = (function () {
                ...
                return (
                  ...
                  (e.parse = function (e, t) {
                    ...
                    var n = d.exec(e);
                    return n
                      ? new m(n[2] || f, j(n[4] || f), j(n[5] || f), j(n[7] || f), j(n[9] || f), t)
                      : new m(f, f, f, f, f);
                  }),
                  (e.file = function (e) {
                    var t = f;
              ...
              if ((o && ((r += o), (r += ':')), (i || 'file' === o) && ((r += l), (r += l)), i)) {
                ...
                if (-1 !== u) {
                  ...
                  (i = i.substr(u + 1)),
                    -1 === (u = f.indexOf(':'))
                      ? (r += n(f, !1))
                      : ((r += n(f.substr(0, u), !1)), (r += ':'), (r += n(f.substr(u + 1), !1))),
                    (r += '@');
                }
        ...
        switch (u) {
          ...
          case 13:
            ...
            1 === c.getTokenError() && h + 1 < e.lineCount
              ...
              : h < m &&
                (f({ startLine: h, endLine: m, kind: r.FoldingRangeKind.Comment }), (s = h));
            break;
          case 12:
            var g = e
              .getText()
    ...
    return (
      ...
      (e.prototype._getTextDocument = function (e) {
        for (var t = 0, r = this._ctx.getMirrorModels(); t < r.length; t++) {
          var o = r[t];
          if (o.uri.toString() === e)
            return n.TextDocument.create(e, this._languageId, o.version, o.getValue());
        }
        return null;
      }),
      e
  ...
  function c(e) {
    for (var t = [], n = 0, r = e; n < r.length; n++) {
      ...
      0 === o.length ||
        ...
        (2 === o.length && o.charCodeAt(0) === s && o.charCodeAt(1) === s ? t.pop() : t.push(o));
    }
