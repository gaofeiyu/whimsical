...
define(
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (r) {
              switch (r.label) {
                case 0:
                  return this._worker
                    ? ((e = ++this._updateExtraLibsToken), [4, this._worker.getProxy()])
                    : [2];
                case 1:
                  return (
                    (t = r.sent()),
  ...
  define('vs/language/typescript/lib/lib.index', ['require', 'exports'], function (e, t) {
    'use strict';
      ...
      c = (function () {
        ...
        return (
          (e.prototype.isLibFile = function (e) {
            return !!e && 0 === e.path.indexOf('/lib.') && !!n.libFileSet[e.path.slice(1)];
          }),
          (e.prototype.getOrCreateModel = function (e) {
            ...
            return (
              ...
              (this.isLibFile(e) && this._hasFetchedLibFiles
                ? i.editor.createModel(this._libFiles[e.path.slice(1)], 'typescript', e)
                : null)
            );
          }),
            ...
            if (e.getModeId() === n) {
              var t,
                ...
                a = e.onDidChangeAttached(function () {
                  o._defaults.getDiagnosticsOptions().onlyVisible &&
                    (e.isAttachedToEditor() ? r() : i.editor.setModelMarkers(e, o._selector, []));
                });
                    ...
                    : ((u = l
                        ...
                        .filter(function (e) {
                          return (
                            -1 ===
                            (
                              d._defaults.getDiagnosticsOptions().diagnosticCodesToIgnore || []
                            ).indexOf(e.code)
                          );
                        })),
                      (c = u
              ...
              switch (c.label) {
                case 0:
                  return (
                    ...
                    (s = new i.Range(r.lineNumber, n.startColumn, r.lineNumber, n.endColumn)),
                    (o = e.uri),
                    (a = e.getOffsetAt(r)),
                    [4, this._worker(o)]
                  );
                case 1:
                  return (
                    (l = c.sent()),
                    e.isDisposed() ? [2] : [4, l.getCompletionsAtPosition(o.toString(), a)]
                  );
                case 2:
                          ...
                          suggestions: u.entries.map(function (n) {
                            ...
                            if (n.replacementSpan) {
                              var c = e.getPositionAt(n.replacementSpan.start),
                                d = e.getPositionAt(
                                  n.replacementSpan.start + n.replacementSpan.length
                                );
                              u = new i.Range(c.lineNumber, c.column, d.lineNumber, d.column);
                            }
                            var p = [];
                            return (
                              -1 !==
        ...
        (t.prototype.resolveCompletionItem = function (e, r) {
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (l) {
              switch (l.label) {
                case 0:
                  return (n = (r = e).uri), (i = r.position), (s = r.offset), [4, this._worker(n)];
                case 1:
                  return [4, l.sent().getCompletionEntryDetails(n.toString(), s, r.label)];
                case 2:
                  return (o = l.sent())
                    ? [
                        2,
        ...
        (t.prototype.provideSignatureHelp = function (e, r, n, i) {
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (c) {
              switch (c.label) {
                case 0:
                  return (n = e.uri), (s = e.getOffsetAt(r)), [4, this._worker(n)];
                case 1:
                  return (
                    (o = c.sent()),
                    e.isDisposed()
                        ...
                        (t.documentation = { value: a(e.documentation) }),
                          ...
                          e.parameters.forEach(function (r, n, i) {
                            var s = a(r.displayParts),
                              o = { label: s, documentation: { value: a(r.documentation) } };
                            (t.label += s),
                              t.parameters.push(o),
                              n < i.length - 1 && (t.label += a(e.separatorDisplayParts));
                          }),
        ...
        (t.prototype.provideHover = function (e, t, r) {
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (c) {
              switch (c.label) {
                case 0:
                  return (r = e.uri), (n = e.getOffsetAt(t)), [4, this._worker(r)];
                case 1:
                  return (
                    (i = c.sent()),
                    e.isDisposed() ? [2] : [4, i.getQuickInfoAtPosition(r.toString(), n)]
                  );
                case 2:
            ...
            return __generator(this, function (l) {
              switch (l.label) {
                ...
                case 1:
                  return (
                    (s = l.sent()),
                    e.isDisposed() ? [2] : [4, s.getOccurrencesAtPosition(r.toString(), n)]
                  );
                case 2:
        ...
        (t.prototype.provideDefinition = function (e, t, n) {
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (h) {
              switch (h.label) {
                case 0:
                  return (n = e.uri), (s = e.getOffsetAt(t)), [4, this._worker(n)];
                case 1:
                  return (
                    (o = h.sent()),
                    e.isDisposed() ? [2] : [4, o.getDefinitionAtPosition(n.toString(), s)]
                  );
                case 2:
                ...
                case 3:
                  ...
                  for (l = [], u = 0, c = a; u < c.length; u++)
                    if (
                      ...
                      l.push({ uri: p, range: this._textSpanToRange(g, d.textSpan) });
                    else if ((f = r.typescriptDefaults.getExtraLibs()[d.fileName]))
                      return (
                        (b = i.editor.createModel(f.content, 'typescript', p)),
                        [2, { uri: p, range: this._textSpanToRange(b, d.textSpan) }]
                      );
                  return [2, l];
              }
            });
            ...
            return __generator(this, function (g) {
              switch (g.label) {
                ...
                case 1:
                  return (
                    (s = g.sent()),
                    e.isDisposed() ? [2] : [4, s.getReferencesAtPosition(r.toString(), n)]
                  );
                case 2:
                  ...
                  for (a = [], l = 0, u = o; l < u.length; l++)
                    (c = u[l]),
                      ...
                      (p = this._libFiles.getOrCreateModel(d)) &&
                        a.push({ uri: d, range: this._textSpanToRange(p, c.textSpan) });
                  return [2, a];
              }
            });
          });
            ...
            return __generator(this, function (l) {
              switch (l.label) {
                ...
                case 1:
                  return (
                    (r = l.sent()),
                    e.isDisposed() ? [2] : [4, r.getNavigationBarItems(t.toString())]
                  );
                case 2:
                  return !(n = l.sent()) || e.isDisposed()
                    ...
                    : ((s = function (t, r, n) {
                        ...
                        if ((n && (o.containerName = n), r.childItems && r.childItems.length > 0))
              ...
              switch (u.label) {
                ...
                case 1:
                  return (
                    ...
                    e.isDisposed()
                      ? [2]
                      : [4, o.getFormattingEditsForRange(n.toString(), i, s, w._convertOptions(r))]
                  );
                case 2:
            ...
            return __generator(this, function (d) {
              switch (d.label) {
                ...
                case 1:
                  return (
                    (l = d.sent()),
                    e.isDisposed() ? [2] : [4, l.getCodeFixesAtPosition(n.toString(), i, s, a, o)]
                  );
                case 2:
                    ...
                    : [
                        2,
                        {
                          actions: u
                            ...
                            .map(function (t) {
                              return c._tsCodeFixActionToMonacoCodeAction(e, r, t);
                            }),
                          dispose: function () {},
                        },
                      ];
          ...
          return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (h) {
              switch (h.label) {
                case 0:
                  return (
                    (n = e.uri), (s = n.toString()), (o = e.getOffsetAt(t)), [4, this._worker(n)]
                  );
                case 1:
                  return (
                    (a = h.sent()),
                    e.isDisposed()
                      ? [2]
                      : [4, a.getRenameInfo(s, o, { allowRenameOfImportPath: !1 })]
                  );
                case 2:
                  if (!1 === (l = h.sent()).canRename)
                    return [2, { edits: [], rejectReason: l.localizedErrorMessage }];
                ...
                case 3:
                  ...
                  for (c = [], d = 0, p = u; d < p.length; d++) {
                    if (((g = p[d]), (f = i.Uri.parse(g.fileName)), !(b = i.editor.getModel(f))))
                      throw new Error('Unknown URI ' + f + '.');
                    c.push({
                      resource: f,
                      edit: { range: this._textSpanToRange(b, g.textSpan), text: r },
                    });
                  }
                  return [2, { edits: c }];
              }
    ...
    function (e, t, r, n, i) {
      ...
      function a(e, t) {
        ...
        return (
          ...
          i.languages.registerSignatureHelpProvider(t, new n.SignatureHelpAdapter(o)),
          i.languages.registerHoverProvider(t, new n.QuickInfoAdapter(o)),
          i.languages.registerDocumentHighlightProvider(t, new n.OccurrencesAdapter(o)),
          i.languages.registerDefinitionProvider(t, new n.DefinitionAdapter(a, o)),
          ...
          i.languages.registerDocumentRangeFormattingEditProvider(t, new n.FormatAdapter(o)),
          i.languages.registerOnTypeFormattingEditProvider(t, new n.FormatOnTypeAdapter(o)),
