    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (function (e) {
        (e.create = function (e, t) {
          ...
          (e.is = function (e) {
            var t = e;
            return L.defined(t) && v.is(t.textDocument) && Array.isArray(t.edits);
          });
        ...
        switch (T) {
          ...
          case i.ScannerState.WithinTag:
            return y.skipWhitespace()
              ...
              : g &&
                (_ = y.advanceIfRegExp(/^[^\s"'></=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase())
                  .length > 0
          ...
          case i.ScannerState.BeforeAttributeValue:
            ...
            return a === p || a === u
              ? (y.advance(1),
                ...
                'type' === _ && (w = y.getSource().substring(t + 1, y.pos() - 1)),
                (T = i.ScannerState.WithinTag),
                (g = !1),
                L(t, i.TokenType.AttributeValue))
    ...
    u = (function () {
      ...
      return (
        ...
        (e.prototype._doComplete = function (e, t, a, l) {
          ...
          function C(n, r) {
            var a, o, s, l;
            if ((void 0 === r && (r = _), _ > n && _ <= r && ((l = b[n]), /^["']*$/.test(l)))) {
              var h = n + 1,
                m = r;
              r > n && b[r - 1] === b[n] && m--;
              ...
              (a = k(v, y)), (s = _ >= h && _ <= m ? b.substring(h, _) : ''), (o = !1);
          ...
          function R(e) {
            return _ === y.getTokenEnd() && (U = y.scan()) === e && y.getTokenOffset() === _
              ? y.getTokenEnd()
              : _;
          }
          function I() {
          ...
          function H() {
            for (var e = _ - 1, n = t.character; e >= 0 && o.isLetterOrDigit(b, e); ) e--, n--;
            if (e >= 0 && '&' === b[e]) {
          ...
          for (var z, U = y.scan(); U !== i.TokenType.EOS && y.getTokenOffset() <= _; ) {
            switch (U) {
...
define('vs/language/html/htmlWorker', [
  ...
  'use strict';
  Object.defineProperty(t, '__esModule', { value: !0 }), (t.create = t.HTMLWorker = void 0);
  var i = (function () {
    function e(e, t) {
      (this._ctx = e),
      ...
      if (null == i ? void 0 : i.dataProviders)
        for (var o in i.dataProviders) a.push(n.newHTMLDataProvider(o, i.dataProviders[o]));
    ...
    return (
      ...
      (e.prototype._getTextDocument = function (e) {
        for (var t = 0, i = this._ctx.getMirrorModels(); t < i.length; t++) {
          var r = i[t];
          if (r.uri.toString() === e)
            return n.TextDocument.create(e, this._languageId, r.version, r.getValue());
        }
        return null;
      }),
      e
