 ...
 *-----------------------------------------------------------*/ (function () {
    ...
    var E = (function () {
      ...
      return (
        (p.prototype.record = function (o, h) {
          this._events.push(new t(o, h, I.Utilities.getHighPerformanceTimestamp()));
        }),
        ...
        (E.recursiveClone = function (M) {
          ...
          return (
            E.forEachProperty(M, function (o, h) {
              h && typeof h == 'object' ? (p[o] = E.recursiveClone(h)) : (p[o] = h);
            }),
            p
          );
        }),
          ...
          return (
            this.PERFORMANCE_NOW_PROBED ||
              ...
              (this.HAS_PERFORMANCE_NOW =
                I.global.performance && typeof I.global.performance.now == 'function')),
      ...
      return (
        (p.validateConfigurationOptions = function (o) {
          function h(l) {
            ...
            if (l.phase === 'factory') {
              console.error('The factory method of "' + l.moduleId + '" has thrown an exception'),
                console.error(l);
              return;
            }
          }
          if (
            ...
            Array.isArray(o.ignoreDuplicateModules) || (o.ignoreDuplicateModules = []),
            o.baseUrl.length > 0 && (I.Utilities.endsWith(o.baseUrl, '/') || (o.baseUrl += '/')),
            typeof o.cspNonce != 'string' && (o.cspNonce = ''),
            typeof o.preferScriptTags == 'undefined' && (o.preferScriptTags = !1),
            Array.isArray(o.nodeModules) || (o.nodeModules = []),
            o.nodeCachedData &&
              typeof o.nodeCachedData == 'object' &&
              (typeof o.nodeCachedData.seed != 'string' && (o.nodeCachedData.seed = 'seed'),
              (typeof o.nodeCachedData.writeDelay != 'number' || o.nodeCachedData.writeDelay < 0) &&
                (o.nodeCachedData.writeDelay = 1e3 * 7),
              !o.nodeCachedData.path || typeof o.nodeCachedData.path != 'string'))
          ) {
        ...
        (p.mergeConfigurationOptions = function (o, h) {
          ...
          return (
            I.Utilities.forEachProperty(o, function (l, f) {
              l === 'ignoreDuplicateModules' && typeof u.ignoreDuplicateModules != 'undefined'
                ? (u.ignoreDuplicateModules = u.ignoreDuplicateModules.concat(f))
      ...
      return (
        (p.prototype._createIgnoreDuplicateModulesMap = function () {
          ...
          for (var o = 0; o < this.options.ignoreDuplicateModules.length; o++)
            this.ignoreDuplicateModulesMap[this.options.ignoreDuplicateModules[o]] = !0;
        }),
        ...
        (p.prototype._applyPaths = function (o) {
          for (var h, u = 0, l = this.sortedPathsRules.length; u < l; u++)
            if (((h = this.sortedPathsRules[u]), I.Utilities.startsWith(o, h.from))) {
        ...
        (p.prototype.moduleIdToPaths = function (o) {
          ...
          var u = o,
            l;
          if (!I.Utilities.endsWith(u, '.js') && !I.Utilities.isAbsolutePath(u)) {
            l = this._applyPaths(u);
            for (var f = 0, L = l.length; f < L; f++)
              (this.isBuild() && l[f] === 'empty:') ||
                (I.Utilities.isAbsolutePath(l[f]) || (l[f] = this.options.baseUrl + l[f]),
  ...
  (function (I) {
    var t = (function () {
        function u(l) {
          (this._env = l), (this._scriptLoader = null), (this._callbackMap = {});
        }
        return (
          (u.prototype.load = function (l, f, L, a) {
            ...
            if (!this._scriptLoader)
              if (this._env.isWebWorker) this._scriptLoader = new M();
                ...
                g ? (this._scriptLoader = new E()) : (this._scriptLoader = new p(this._env));
              } else
                this._env.isNode
      ...
      E = (function () {
        ...
        return (
          (u.prototype.attachListeners = function (l, f, L) {
            var a = function () {
                l.removeEventListener('load', _), l.removeEventListener('error', g);
              },
              _ = function (m) {
                a(), f();
              },
...
//# sourceURL=` +
                    f;
                  var i = _ ? self.eval(_.createScript('', m)) : new Function(m);
                  i.call(self), L();
                })
                .then(void 0, a);
              return;
      ...
      p = (function () {
        function u(l) {
          (this._env = l), (this._didInitialize = !1), (this._didPatchNodeRequire = !1);
        }
        return (
          ...
          (u.prototype._initNodeRequire = function (l, f) {
            ...
            _.prototype._compile = function (m, i) {
              ...
              try {
                ...
                (r = c.slice(0, 16)), (n.cachedData = c.slice(16)), d.record(60, S);
              } catch (P) {
                d.record(61, S);
              }
          ...
          (u.prototype.load = function (l, f, L, a) {
            ...
            if (/^node\|/.test(f)) {
              ...
              this._readSourceAndCachedData(n, C, s, function (b, v, w, N) {
                ...
                _._handleCachedData(U, y, C, c && !w, l), _._verifyCachedData(U, y, C, N, l);
              });
            }
          }),
          (u.prototype._createAndEvalScript = function (l, f, L, a, _) {
            ...
            return (
              ...
              d ? a() : _(new Error("Didn't receive define call in " + L.filename + '!')),
              m
            );
          }),
          ...
          (u.prototype._createAndWriteCachedData = function (l, f, L, a) {
            var _ = this,
              ...
              d = function () {
                setTimeout(function () {
                  s || (s = _._crypto.createHash('md5').update(f, 'utf8').digest());
                  ...
                  if (!(S.length === 0 || S.length === m || i >= 5)) {
                    ...
                    (m = S.length),
                      _._fs.writeFile(L, Buffer.concat([s, S]), function (n) {
                        n && a.getConfig().onError(n), a.getRecorder().record(63, L), d();
                      });
                  }
                }, g * Math.pow(4, i++));
              };
          ...
          (u.prototype._verifyCachedData = function (l, f, L, a, _) {
            ...
            !a ||
              l.cachedDataRejected ||
              setTimeout(function () {
                var m = g._crypto.createHash('md5').update(f, 'utf8').digest();
                a.equals(m) ||
                  (_.getConfig().onError(
                    new Error(
  ...
  (function (I) {
    var t = (function () {
      function u(l) {
        var f = l.lastIndexOf('/');
        f !== -1 ? (this.fromModulePath = l.substr(0, f + 1)) : (this.fromModulePath = '');
      }
      return (
        ...
        (u.prototype.resolveModule = function (l) {
          ...
          return (
            I.Utilities.isAbsolutePath(f) ||
              ((I.Utilities.startsWith(f, './') || I.Utilities.startsWith(f, '../')) &&
      ...
      return (
        ...
        (u.prototype.complete = function (l, f, L) {
          ...
          if (a) {
            ...
            (g.phase = 'factory'), (g.moduleId = this.strId), (this.error = g), f.onError(g);
          }
    ...
    var h = (function () {
      ...
      return (
        ...
        (u._findRelevantLocationInStack = function (l, f) {
          ...
          throw new Error('Could not correlate define call site for needle ' + l);
        }),
        (u.prototype.getBuildInfo = function () {
          if (!this._config.isBuild()) return null;
          for (var l = [], f = 0, L = 0, a = this._modules2.length; L < a; L++) {
            ...
            if (!!_) {
              ...
              l[f++] = {
                id: _.strId,
                path: g,
                defineLocation: g && m ? u._findRelevantLocationInStack(g, m) : null,
                dependencies: i,
                shim: null,
                exports: _.exports,
              };
          ...
          return (
            this._recorder ||
              (this._config.shouldRecordStats()
                ? (this._recorder = new I.LoaderEventRecorder(this._loaderAvailableTimestamp))
        ...
        (u.prototype.enqueueDefineAnonymousModule = function (l, f) {
          ...
          this._config.isBuild() && (L = new Error('StackLocation').stack || null),
            (this._currentAnnonymousDefineCall = { stack: L, dependencies: l, callback: f });
        }),
        (u.prototype.defineModule = function (l, f, L, a, _, g) {
          ...
          (this._modules2[i] = s),
            this._config.isBuild() &&
              ...
              (this._buildInfoDependencies[i] = (s.dependencies || []).map(function (d) {
        ...
        (u.prototype._relativeRequire = function (l, f, L, a) {
          ...
          this.defineModule(I.Utilities.generateAnonymousModule(), f, L, a, null, l);
        }),
        ...
        (u.prototype._onLoadError = function (l, f) {
          ...
          for (var a = [], _ = 0, g = this._moduleIdProvider.getMaxModuleId(); _ < g; _++)
            a[_] = !1;
          var m = !1,
            i = [];
        ...
        (u.prototype._loadModule = function (l) {
          ...
          if (!(this._modules2[l] || this._knownModules2[l])) {
            ...
            var L = this._moduleIdProvider.getStrModuleId(l),
              ...
              _ = /^@[^\/]+\/[^\/]+$/;
            this._env.isNode && (L.indexOf('/') === -1 || _.test(L)) && a.push('node|' + L);
            var g = -1,
              m = function (i) {
                if ((g++, g >= a.length)) f._onLoadError(l, i);
                  ...
                  if (f._config.isBuild() && s === 'empty:') {
                    (f._buildInfoPath[l] = s),
                      f.defineModule(f._moduleIdProvider.getStrModuleId(l), [], null, null, null),
                      f._onLoad(l);
                    return;
                  }
                  d.record(10, s),
        ...
        (u.prototype._loadPluginDependency = function (l, f) {
          ...
          if (!(this._modules2[f.id] || this._knownModules2[f.id])) {
            ...
            var a = function (_) {
              L.defineModule(L._moduleIdProvider.getStrModuleId(f.id), [], _, null, null);
            };
            (a.error = function (_) {
...
`)
              ...
              if (
                ((this._inverseDependencies2[g.id] = this._inverseDependencies2[g.id] || []),
                ...
                d || ((d = []), this._inversePluginDependencies2.set(g.pluginId, d)),
                  d.push(g),
            ...
            if (((this._inverseDependencies2[l.id] = null), d))
              for (var g = 0, m = d.length; g < m; g++) {
                ...
                n.unresolvedDependenciesCount--,
                  n.unresolvedDependenciesCount === 0 && this._onModuleComplete(n);
              }
            var r = this._inversePluginDependencies2.get(l.id);
            if (r) {
              this._inversePluginDependencies2.delete(l.id);
              for (var g = 0, m = r.length; g < m; g++) this._loadPluginDependency(l.exports, r[g]);
            }
          }
        }),
        u
    ...
    var t = new I.Environment(),
      ...
      M = function (u, l, f) {
        typeof u != 'string' && ((f = l), (l = u), (u = null)),
          ...
          u ? E.defineModule(u, l, f, null, null) : E.enqueueDefineAnonymousModule(l, f);
      };
    M.amd = { jQuery: !0 };
    var p = function (u, l) {
      ...
      o = function () {
        if (arguments.length === 1) {
          ...
          if (typeof arguments[0] == 'string') return E.synchronousRequire(arguments[0]);
        }
    ...
    function h() {
      if (typeof I.global.require != 'undefined' || typeof require != 'undefined') {
        ...
        if (typeof u == 'function' && typeof u.resolve == 'function') {
          ...
          (I.global.nodeRequire = l), (o.nodeRequire = l), (o.__$__nodeRequire = l);
        }
      }
      t.isNode && !t.isElectronRenderer
        ? ((module.exports = o), (require = o))
        : (t.isElectronRenderer || (I.global.define = M), (I.global.require = o));
    }
    (I.init = h),
...
` +
      ...
      t.canceled = l;
      function f(a) {
        return a ? new Error(`Illegal argument: ${a}`) : new Error('Illegal argument');
      }
      t.illegalArgument = f;
      function L(a) {
    ...
    z(G[15], Q([0, 1]), function (I, t) {
      ...
      (function (M) {
        ...
        function* S(c, C, b = c.length) {
          for (
            C < 0 && (C += c.length), b < 0 ? (b += c.length) : b > c.length && (b = c.length);
            C < b;
            C++
          )
            yield c[C];
    ...
    z(G[16], Q([0, 1, 4]), function (I, t, E) {
      ...
      class M {
        ...
        define(s, d) {
          (this._keyCodeToStr[s] = d), (this._strToKeyCode[d.toLowerCase()] = s);
        }
        keyCodeToStr(s) {
    ...
    z(G[7], Q([0, 1, 15]), function (I, t, E) {
      ...
      class _ {
        ...
        add(d) {
          if (!d) return d;
          if (d === this) throw new Error('Cannot register a disposable on itself!');
          return (
            o(d),
            this._isDisposed
    ...
    z(G[17], Q([0, 1]), function (I, t) {
      ...
      class E {
        constructor(o) {
          (this.element = o), (this.next = E.Undefined), (this.prev = E.Undefined);
        }
      }
    ...
    z(G[2], Q([0, 1]), function (I, t) {
      ...
      let i;
      typeof t.globals.vscode != 'undefined' && typeof t.globals.vscode.process != 'undefined'
      ...
      if (
        ...
        (t.isPreferringBrowserCodeLoad = typeof t.browserCodeLoadingCacheStrategy == 'string'),
        ...
        (m = navigator.userAgent),
          ...
          (L =
            (m.indexOf('Macintosh') >= 0 || m.indexOf('iPad') >= 0 || m.indexOf('iPhone') >= 0) &&
      ...
      function r() {
        if (!n) {
          ...
          (c[0] = 1), (c[1] = 2), (S = new Uint16Array(c.buffer)[0] === (2 << 8) + 1);
        }
        return S;
      }
      t.isLittleEndian = r;
    ...
    z(G[18], Q([0, 1, 2]), function (I, t, E) {
      ...
      if (
        ...
        typeof process != 'undefined'
          ...
          : (M = {
              get platform() {
                return E.isWindows ? 'win32' : E.isMacintosh ? 'darwin' : 'linux';
              },
              nextTick(p) {
    ...
    z(G[19], Q([0, 1, 18]), function (I, t, E) {
      ...
      class _ extends Error {
        constructor(r, c, C) {
          ...
          (w += `. Received type ${typeof C}`), super(w), (this.code = 'ERR_INVALID_ARG_TYPE');
        }
      }
      function g(n, r) {
              ...
              if (N === 2) {
                if (
                  ...
                  if (b.length > 2) {
                    ...
                    U === -1
                      ? ((b = ''), (v = 0))
                      : ((b = b.slice(0, U)), (v = b.length - 1 - b.lastIndexOf(c))),
                      (w = P),
                      (N = 0);
                    continue;
                  } else if (b.length !== 0) {
                ...
                b.length > 0 ? (b += `${c}${n.slice(w + 1, P)}`) : (b = n.slice(w + 1, P)),
                  (v = P - w - 1);
            (w = P), (N = 0);
          } else y === u && N !== -1 ? ++N : (N = -1);
        }
      ...
      function S(n, r) {
        if (r === null || typeof r != 'object') throw new _('pathObject', 'Object', r);
      ...
      (t.win32 = {
          ...
          for (let b = n.length - 1; b >= -1; b--) {
            ...
            if (b >= 0) {
              ...
              r.length === 0
                ...
                : ((v = E.env[`=${r}`] || E.cwd()),
                  (v === void 0 ||
                    (v.slice(0, 2).toLowerCase() !== r.toLowerCase() && v.charCodeAt(2) === f)) &&
                    (v = `${r}\\`));
            const w = v.length;
            let N = 0,
              y = '',
            ...
            if (w === 1) m(U) && ((N = 1), (P = !0));
              ...
              s(U) &&
                v.charCodeAt(1) === L &&
                ((y = v.slice(0, 2)), (N = 2), w > 2 && m(v.charCodeAt(2)) && ((P = !0), (N = 3)));
            if (y.length > 0)
              if (r.length > 0) {
            ...
            if (C) {
              if (r.length > 0) break;
            } else if (((c = `${v.slice(N)}\\${c}`), (C = P), P && r.length > 0)) break;
          }
        ...
        normalize(n) {
          ...
          if (m(v))
            ...
            s(v) &&
              n.charCodeAt(1) === L &&
              ((C = n.slice(0, 2)), (c = 2), r > 2 && m(n.charCodeAt(2)) && ((b = !0), (c = 3)));
        ...
        isAbsolute(n) {
          ...
          return m(c) || (r > 2 && s(c) && n.charCodeAt(1) === L && m(n.charCodeAt(2)));
        },
        join(...n) {
          ...
          for (let v = 0; v < n.length; ++v) {
            const w = n[v];
            g(w, 'path'), w.length > 0 && (r === void 0 ? (r = c = w) : (r += `\\${w}`));
          }
          if (r === void 0) return '.';
          let C = !0,
            b = 0;
          if (typeof c == 'string' && m(c.charCodeAt(0))) {
            ++b;
            const v = c.length;
            v > 1 && m(c.charCodeAt(1)) && (++b, v > 2 && (m(c.charCodeAt(2)) ? ++b : (C = !1)));
          }
          if (C) {
        ...
        relative(n, r) {
          ...
          const c = t.win32.resolve(n),
            C = t.win32.resolve(r);
          if (c === C || ((n = c.toLowerCase()), (r = C.toLowerCase()), n === r)) return '';
          let b = 0;
          ...
          let Y = '';
          for (q = b + R + 1; q <= v; ++q)
            (q === v || n.charCodeAt(q) === f) && (Y += Y.length === 0 ? '..' : '\\..');
          return (
            (N += R),
            Y.length > 0 ? `${Y}${C.slice(N, y)}` : (C.charCodeAt(N) === f && ++N, C.slice(N, y))
          );
        },
        toNamespacedPath(n) {
          ...
          } else if (s(r.charCodeAt(0)) && r.charCodeAt(1) === L && r.charCodeAt(2) === f)
            return `\\\\?\\${r}`;
          return n;
        },
        dirname(n) {
          ...
          if (m(b)) {
            ...
            s(b) && n.charCodeAt(1) === L && ((c = r > 2 && m(n.charCodeAt(2)) ? 3 : 2), (C = c));
          let v = -1,
            w = !0;
          for (let N = r - 1; N >= C; --N)
            if (m(n.charCodeAt(N))) {
        ...
        basename(n, r) {
          ...
          let c = 0,
            ...
            v;
          if (
            (n.length >= 2 && s(n.charCodeAt(0)) && n.charCodeAt(1) === L && (c = 2),
            ...
            for (v = n.length - 1; v >= c; --v) {
              ...
              if (m(y)) {
                ...
                N === -1 && ((b = !1), (N = v + 1)),
                  w >= 0 && (y === r.charCodeAt(w) ? --w == -1 && (C = v) : ((w = -1), (C = N)));
            }
            return c === C ? (C = N) : C === -1 && (C = n.length), n.slice(c, C);
          }
          for (v = n.length - 1; v >= c; --v)
            if (m(n.charCodeAt(v))) {
              if (!b) {
        ...
        extname(n) {
          ...
          let r = 0,
            ...
            v = !0,
            w = 0;
          n.length >= 2 && n.charCodeAt(1) === L && s(n.charCodeAt(0)) && (r = C = 2);
          for (let N = n.length - 1; N >= r; --N) {
            ...
            b === -1 && ((v = !1), (b = N + 1)),
              y === u ? (c === -1 ? (c = N) : w !== 1 && (w = 1)) : c !== -1 && (w = -1);
          }
          return c === -1 || b === -1 || w === 0 || (w === 1 && c === b - 1 && c === C + 1)
            ? ''
            : n.slice(c, b);
        },
        format: S.bind(null, '\\'),
        parse(n) {
          ...
          let C = 0,
            b = n.charCodeAt(0);
          if (c === 1) return m(b) ? ((r.root = r.dir = n), r) : ((r.base = r.name = n), r);
          if (m(b)) {
          ...
          for (; P >= C; --P) {
            ...
            N === -1 && ((y = !1), (N = P + 1)),
              b === u ? (v === -1 ? (v = P) : U !== 1 && (U = 1)) : v !== -1 && (U = -1);
          }
          return (
            N !== -1 &&
              (v === -1 || U === 0 || (U === 1 && v === N - 1 && v === w + 1)
                ? (r.base = r.name = n.slice(w, N))
                : ((r.name = n.slice(w, v)), (r.base = n.slice(w, N)), (r.ext = n.slice(v, N)))),
        ...
        (t.posix = {
          resolve(...n) {
            ...
            for (let C = n.length - 1; C >= -1 && !c; C--) {
              ...
              g(b, 'path'), b.length !== 0 && ((r = `${b}/${r}`), (c = b.charCodeAt(0) === l));
            }
          ...
          join(...n) {
            ...
            for (let c = 0; c < n.length; ++c) {
              const C = n[c];
              g(C, 'path'), C.length > 0 && (r === void 0 ? (r = C) : (r += `/${C}`));
            }
          ...
          relative(n, r) {
            if (
              (g(n, 'from'),
              g(r, 'to'),
              n === r || ((n = t.posix.resolve(n)), (r = t.posix.resolve(r)), n === r))
            )
              return '';
            const c = 1,
              C = n.length,
            ...
            if (P === N)
              ...
              } else b > N && (n.charCodeAt(c + P) === l ? (y = P) : P === 0 && (y = 0));
            let U = '';
            for (P = c + y + 1; P <= C; ++P)
              (P === C || n.charCodeAt(P) === l) && (U += U.length === 0 ? '..' : '/..');
          ...
          dirname(n) {
            ...
            return c === -1 ? (r ? '/' : '.') : r && c === 1 ? '//' : n.slice(0, c);
          },
          basename(n, r) {
            r !== void 0 && g(r, 'ext'), g(n, 'path');
            let c = 0,
          ...
          extname(n) {
            ...
            for (let w = n.length - 1; w >= 0; --w) {
              ...
              C === -1 && ((b = !1), (C = w + 1)),
                N === u ? (r === -1 ? (r = w) : v !== 1 && (v = 1)) : r !== -1 && (v = -1);
            }
            return r === -1 || C === -1 || v === 0 || (v === 1 && r === C - 1 && r === c + 1)
              ? ''
              : n.slice(r, C);
          },
          format: S.bind(null, '/'),
          parse(n) {
            ...
            for (; y >= C; --y) {
              ...
              w === -1 && ((N = !1), (w = y + 1)),
                U === u ? (b === -1 ? (b = y) : P !== 1 && (P = 1)) : b !== -1 && (P = -1);
            }
            if (w !== -1) {
              const U = v === 0 && c ? 1 : v;
              b === -1 || P === 0 || (P === 1 && b === w - 1 && b === v + 1)
                ? (r.base = r.name = n.slice(U, w))
                : ((r.name = n.slice(U, b)), (r.base = n.slice(U, w)), (r.ext = n.slice(b, w)));
            }
        ...
        (t.normalize = E.platform === 'win32' ? t.win32.normalize : t.posix.normalize),
        (t.resolve = E.platform === 'win32' ? t.win32.resolve : t.posix.resolve),
        (t.relative = E.platform === 'win32' ? t.win32.relative : t.posix.relative),
        (t.dirname = E.platform === 'win32' ? t.win32.dirname : t.posix.dirname),
        (t.basename = E.platform === 'win32' ? t.win32.basename : t.posix.basename),
        (t.extname = E.platform === 'win32' ? t.win32.extname : t.posix.extname),
    ...
    z(G[8], Q([0, 1, 2]), function (I, t, E) {
      ...
      class p {
        constructor(h) {
          (this._highResolution = M && h), (this._startTime = this._now()), (this._stopTime = -1);
        }
        static create(h = !0) {
          return new p(h);
        }
        ...
        _now() {
          return this._highResolution ? E.globals.performance.now() : Date.now();
        }
      }
      t.StopWatch = p;
    }),
    z(G[9], Q([0, 1, 4, 7, 17, 8]), function (I, t, E, M, p, o) {
            ...
            onFirstListenerAdd() {
              V = T((oe) => {
                re++,
                  ...
                  (J = setTimeout(() => {
                    const ue = X;
                    (X = void 0), (J = void 0), (!e || re > 1) && se.fire(ue), (re = 0);
                  }, O));
              });
            },
            onLastListenerRemove() {
        ...
        stop() {
          if (this._stopWatch) {
            ...
            (this._elapsedOverall += i),
              ...
              console.info(
                `did FIRE ${this._name}: elapsed_ms: ${i.toFixed(5)}, listener: ${
                  this._listenerCount
      ...
      let l = -1;
      class f {
        constructor(i, s = Math.random().toString(18).slice(2, 5)) {
          (this.customThreshold = i), (this.name = s), (this._warnCountdown = 0);
        }
        dispose() {
        ...
        check(i) {
          let s = l;
          if (
            (typeof this.customThreshold == 'number' && (s = this.customThreshold), s <= 0 || i < s)
          )
            return;
...
`),
          ...
          if ((this._stacks.set(d, S + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)) {
            this._warnCountdown = s * 0.5;
            let n,
              r = 0;
            for (const [c, C] of this._stacks) (!n || r < C) && ((n = c), (r = C));
            console.warn(
      ...
      class L {
        constructor(i) {
          ...
          (this._disposed = !1),
            (this._options = i),
            (this._leakageMon =
              l > 0 ? new f(this._options && this._options.leakWarningThreshold) : void 0),
            (this._perfMon = ((s = this._options) === null || s === void 0 ? void 0 : s._profName)
            ...
            this._event ||
              (this._event = (i, s, d) => {
                ...
                return (
                  ...
                  d instanceof M.DisposableStore ? d.add(C) : Array.isArray(d) && d.push(C),
                  C
                );
              }),
            this._event
        ...
        fire(i) {
          ...
          if (this._listeners) {
            ...
            for (
              (s = this._perfMon) === null || s === void 0 || s.start(this._deliveryQueue.size);
        ...
        dispose() {
          ...
          this._disposed ||
            ...
            (S = (d = this._options) === null || d === void 0 ? void 0 : d.onLastListenerRemove) ===
              null ||
              S === void 0 ||
              S.call(d),
      ...
      class a extends L {
        ...
        fire(i) {
          this._listeners && (this._isPaused !== 0 ? this._eventQueue.push(i) : super.fire(i));
        }
      }
    ...
    z(G[20], Q([0, 1, 9]), function (I, t, E) {
      ...
      class o {
        ...
        get onCancellationRequested() {
          return this._isCancelled
            ? M
            : (this._emitter || (this._emitter = new E.Emitter()), this._emitter.event);
        }
        dispose() {
      ...
      class h {
        constructor(l) {
          (this._token = void 0),
            ...
            (this._parentListener = l && l.onCancellationRequested(this.cancel, this));
        }
        get token() {
    ...
    z(G[5], Q([0, 1]), function (I, t) {
      ...
      t.createRegExp = _;
      function g(A) {
        return A.source === '^' || A.source === '^$' || A.source === '$' || A.source === '^\\s*$'
          ? !1
      ...
      function C(A, D, F = 0, k = A.length, H = 0, $ = D.length) {
        for (; F < k && H < $; F++, H++) {
          ...
          if (!(ce === 32 && v(ne)) && !(ce === -32 && v(ee)))
            return b(ee) && b(ne) ? ce : r(A.toLowerCase(), D.toLowerCase(), F, k, H, $);
        }
        const x = k - F,
          K = $ - H;
        return x < K ? -1 : x > K ? 1 : 0;
        ...
        for (let k = 0; k < F; k++) {
          ...
          if (H !== $) {
            if (w(H) && w($)) {
              ...
              String.fromCharCode(H).toLowerCase() !== String.fromCharCode($).toLowerCase()
            )
              return !1;
          }
        }
      ...
      function U(A, D) {
        ...
        for (F = 0; F < k; F++) if (A.charCodeAt(F) !== D.charCodeAt(F)) return F;
        return k;
      }
      ...
      function R(A, D) {
        ...
        const H = A.length - 1,
          $ = D.length - 1;
        for (F = 0; F < k; F++) if (A.charCodeAt(H - F) !== D.charCodeAt($ - F)) return F;
        return k;
      }
      ...
      function ge(A) {
        for (let D = 0, F = A.length; D < F; D++) if (fe(A.charCodeAt(D))) return !0;
        return !1;
      }
      ...
      function fe(A) {
        return (
          (A = +A),
          (A >= 11904 && A <= 55215) || (A >= 63744 && A <= 64255) || (A >= 65281 && A <= 65374)
        );
      }
      ...
      (t.isEmojiImprecise = he), (t.UTF8_BOM_CHARACTER = String.fromCharCode(65279));
      function _e(A) {
        return !!(A && A.length > 0 && A.charCodeAt(0) === 65279);
      }
      t.startsWithUTF8BOM = _e;
      function ve(A, D = !1) {
        return A ? (D && (A = A.replace(/\\./g, '')), A.toLowerCase() !== A) : !1;
      }
      t.containsUppercaseCharacter = ve;
      function Ce(A) {
        const D = 90 - 65 + 1;
        return (
          (A = A % (2 * D)), A < D ? String.fromCharCode(97 + A) : String.fromCharCode(65 + A - D)
        );
      }
    ...
    z(G[21], Q([0, 1, 5]), function (I, t, E) {
      ...
      function p(i, s) {
        switch (typeof i) {
          case 'object':
            return i === null ? o(349, s) : Array.isArray(i) ? l(i, s) : f(i, s);
          case 'string':
            return u(i, s);
          case 'boolean':
            return h(i, s);
      ...
      class m {
        ...
        update(s) {
          ...
          let n = this._buffLen,
            ...
            c,
            C;
          for (r !== 0 ? ((c = r), (C = -1), (r = 0)) : ((c = s.charCodeAt(0)), (C = 0)); ; ) {
            let b = c;
            if (E.isHighSurrogate(c))
              if (C + 1 < d) {
                const v = s.charCodeAt(C + 1);
                E.isLowSurrogate(v) ? (C++, (b = E.computeCodePoint(c, v))) : (b = 65533);
              } else {
                r = c;
                break;
              }
        ...
        _push(s, d, S) {
          return (
            S < 128
              ? (s[d++] = S)
              : S < 2048
              ? ((s[d++] = 192 | ((S & 1984) >>> 6)), (s[d++] = 128 | ((S & 63) >>> 0)))
              : S < 65536
              ? ((s[d++] = 224 | ((S & 61440) >>> 12)),
                (s[d++] = 128 | ((S & 4032) >>> 6)),
                (s[d++] = 128 | ((S & 63) >>> 0)))
        ...
        _step() {
          const s = m._bigBlock32,
            d = this._buffDV;
          for (let N = 0; N < 64; N += 4) s.setUint32(N, d.getUint32(N, !1), !1);
      ...
      class f {
        ...
        static _getElements(a) {
          ...
          if (f._isStringArray(_)) {
            ...
            for (let m = 0, i = _.length; m < i; m++) g[m] = M.stringHash(_[m], 0);
            return [_, g, !0];
          }
          return _ instanceof Int32Array ? [[], _, !1] : [[], new Int32Array(_), !1];
        }
        ElementsAreEqual(a, _) {
          return this._originalElementsOrHash[a] !== this._modifiedElementsOrHash[_]
            ? !1
            : this._hasStrings
            ? this._originalStringElements[a] === this._modifiedStringElements[_]
            : !0;
        }
        OriginalElementsAreEqual(a, _) {
          return this._originalElementsOrHash[a] !== this._originalElementsOrHash[_]
            ? !1
            : this._hasStrings
            ? this._originalStringElements[a] === this._originalStringElements[_]
            : !0;
        }
        ModifiedElementsAreEqual(a, _) {
          return this._modifiedElementsOrHash[a] !== this._modifiedElementsOrHash[_]
            ? !1
            : this._hasStrings
            ? this._modifiedStringElements[a] === this._modifiedStringElements[_]
            : !0;
        }
        ComputeDiff(a) {
        ...
        _ComputeDiff(a, _, g, m, i) {
          ...
          return i && (d = this.PrettifyChanges(d)), { quitEarly: s[0], changes: d };
        }
        ComputeDiffRecursive(a, _, g, m, i) {
          for (i[0] = !1; a <= _ && g <= m && this.ElementsAreEqual(a, g); ) a++, g++;
          for (; _ >= a && m >= g && this.ElementsAreEqual(_, m); ) _--, m--;
          if (a > _ || g > m) {
            let c;
            return (
              g <= m
                ? (h.Assert(a === _ + 1, 'originalStart should only be one more than originalEnd'),
                  (c = [new E.DiffChange(a, 0, g, m - g + 1)]))
                : a <= _
                ? (h.Assert(g === m + 1, 'modifiedStart should only be one more than modifiedEnd'),
          ...
          if (!i[0]) {
            ...
            return (
              i[0]
                ? (C = [new E.DiffChange(n + 1, _ - (n + 1) + 1, r + 1, m - (r + 1) + 1)])
        ...
        WALKTRACE(a, _, g, m, i, s, d, S, n, r, c, C, b, v, w, N, y, P) {
          ...
          do {
            ...
            e === Y || (e < j && n[e - 1] < n[e + 1])
              ...
              : ((c = n[e - 1] + 1),
                ...
                (T = e - 1 - a)),
              O >= 0 && ((n = this.m_forwardHistory[O]), (a = n[0]), (Y = 1), (j = n.length - 1));
          } while (--O >= -1);
          if (((U = q.getReverseChanges()), P[0])) {
            ...
            if (U !== null && U.length > 0) {
              ...
              (e = Math.max(e, V.getOriginalEnd())), (B = Math.max(B, V.getModifiedEnd()));
            }
            ...
            (q = new l()),
              ...
              (T = b[0] - N[0] - S),
              (W = 1073741824),
              (O = y ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2);
            do {
              const e = T + i;
              e === Y || (e < j && r[e - 1] >= r[e + 1])
                ? ((c = r[e + 1] - 1),
                ...
                : ((c = r[e - 1]),
                  ...
                  (T = e - 1 - i)),
                O >= 0 && ((r = this.m_reverseHistory[O]), (i = r[0]), (Y = 1), (j = r.length - 1));
            } while (--O >= -1);
            R = q.getChanges();
          }
        ...
        ComputeRecursionPoint(a, _, g, m, i, s, d) {
          ...
          for (let T = 1; T <= v / 2 + 1; T++) {
            ...
            for (let B = r; B <= c; B += 2) {
              B === r || (B < c && N[B - 1] < N[B + 1]) ? (S = N[B + 1]) : (S = N[B - 1] + 1),
                (n = S - (B - P) - R);
              const V = S;
              for (; S < _ && n < m && this.ElementsAreEqual(S + 1, n + 1); ) S++, n++;
              if (
                ((N[B] = S),
                S + n > W + O && ((W = S), (O = n)),
                ...
                return (
                  ...
                  V <= y[B] && 1447 > 0 && T <= 1447 + 1
                    ? this.WALKTRACE(P, r, c, R, U, C, b, q, N, y, S, _, i, n, m, s, j, d)
                    : null
                );
            }
            const e = (W - a + (O - g) - T) / 2;
            ...
            for (let B = C; B <= b; B += 2) {
              B === C || (B < b && y[B - 1] >= y[B + 1]) ? (S = y[B + 1] - 1) : (S = y[B - 1]),
                (n = S - (B - U) - q);
              const V = S;
          ...
          return this.WALKTRACE(P, r, c, R, U, C, b, q, N, y, S, _, i, n, m, s, j, d);
        }
        PrettifyChanges(a) {
          for (let _ = 0; _ < a.length; _++) {
            const g = a[_],
              m = _ < a.length - 1 ? a[_ + 1].originalStart : this._originalElementsOrHash.length,
          ...
          for (let _ = a.length - 1; _ >= 0; _--) {
            ...
            if (_ > 0) {
              const c = a[_ - 1];
              (m = c.originalStart + c.originalLength), (i = c.modifiedStart + c.modifiedLength);
            }
            ...
            for (let c = 1; ; c++) {
              ...
              if (
                C < m ||
                b < i ||
                (s && !this.OriginalElementsAreEqual(C, C + g.originalLength)) ||
        ...
        _OriginalRegionIsBoundary(a, _) {
          if (this._OriginalIsBoundary(a) || this._OriginalIsBoundary(a - 1)) return !0;
          if (_ > 0) {
            const g = a + _;
        ...
        _ModifiedRegionIsBoundary(a, _) {
          if (this._ModifiedIsBoundary(a) || this._ModifiedIsBoundary(a - 1)) return !0;
          if (_ > 0) {
            const g = a + _;
        ...
        ConcatenateChanges(a, _) {
          ...
          if (this.ChangesOverlap(a[a.length - 1], _[0], g)) {
            ...
            return u.Copy(a, 0, m, 0, a.length), u.Copy(_, 0, m, a.length, _.length), m;
          }
        }
    ...
    z(G[11], Q([0, 1]), function (I, t) {
      ...
      function f(n, r) {
        if (!n) throw new Error(r ? `Unexpected type, expected '${r}'` : 'Unexpected type');
      }
      t.assertType = f;
      function L(n) {
        if (l(n)) throw new Error('Assertion Failed: argument is undefined or null');
        return n;
      }
      t.assertIsDefined = L;
      function a(n) {
      ...
      function g(n, r) {
        if (M(r)) {
          if (typeof n !== r) throw new Error(`argument does not match constraint: typeof ${r}`);
        } else if (a(r)) {
          try {
            if (n instanceof r) return;
          } catch (c) {}
          if ((!l(n) && n.constructor === r) || (r.length === 1 && r.call(void 0, n) === !0))
            return;
          throw new Error(
      ...
      function m(n) {
        ...
        for (; Object.prototype !== c; )
          (r = r.concat(Object.getOwnPropertyNames(c))), (c = Object.getPrototypeOf(c));
        return r;
      }
    ...
    z(G[13], Q([0, 1, 2, 19]), function (I, t, E, M) {
      ...
      class g {
        ...
        static parse(w, N = !1) {
          const y = _.exec(w);
          return y
            ? new i(y[2] || L, b(y[4] || L), b(y[5] || L), b(y[7] || L), b(y[9] || L), N)
            : new i(L, L, L, L, L);
        }
        static file(w) {
          let N = L;
        ...
        static joinPath(w, ...N) {
          if (!w.path) throw new Error('[UriError]: cannot call joinPath on URI without path');
          let y;
          return (
        ...
        static revive(w) {
          if (w) {
            ...
            {
              const N = new i(w);
              return (N._formatted = w.external), (N._fsPath = w._sep === m ? w.fsPath : null), N;
            }
          } else return w;
        }
      }
      ...
      function d(v, w) {
        ...
        for (let P = 0; P < v.length; P++) {
          ...
          if (
            ...
            y !== -1 && ((N += encodeURIComponent(v.substring(y, P))), (y = -1)),
              N !== void 0 && (N += v.charAt(P));
          else {
            N === void 0 && (N = v.substr(0, P));
            const R = s[U];
            R !== void 0
              ? (y !== -1 && ((N += encodeURIComponent(v.substring(y, P))), (y = -1)), (N += R))
              : y === -1 && (y = P);
          }
        }
        return y !== -1 && (N += encodeURIComponent(v.substring(y))), N !== void 0 ? N : v;
      }
      function S(v) {
        let w;
        ...
        if ((P && ((y += P), (y += ':')), (U || P === 'file') && ((y += a), (y += a)), U)) {
          ...
          if (j !== -1) {
            ...
            (U = U.substr(j + 1)),
              ...
              j === -1
                ? (y += N(T, !1))
                : ((y += N(T.substr(0, j), !1)), (y += ':'), (y += N(T.substr(j + 1), !1))),
              (y += '@');
          }
          (U = U.toLowerCase()),
            (j = U.indexOf(':')),
            j === -1 ? (y += N(U, !1)) : ((y += N(U.substr(0, j), !1)), (y += U.substr(j)));
        }
        if (R) {
          if (R.length >= 3 && R.charCodeAt(0) === 47 && R.charCodeAt(2) === 58) {
            const j = R.charCodeAt(1);
            j >= 65 && j <= 90 && (R = `/${String.fromCharCode(j + 32)}:${R.substr(3)}`);
          } else if (R.length >= 2 && R.charCodeAt(1) === 58) {
            const j = R.charCodeAt(0);
            j >= 65 && j <= 90 && (R = `${String.fromCharCode(j + 32)}:${R.substr(2)}`);
          }
          y += N(R, !0);
        }
        return q && ((y += '?'), (y += N(q, !1))), Y && ((y += '#'), (y += w ? Y : d(Y, !1))), y;
      }
      function c(v) {
        try {
    ...
    z(G[33], Q([0, 1, 4, 7, 2, 11]), function (I, t, E, M, p, o) {
      ...
      class f {
        ...
        sendMessage(m, i) {
          ...
          return new Promise((d, S) => {
            (this._pendingReplies[s] = { resolve: d, reject: S }),
              this._send({ vsWorker: this._workerId, req: s, method: m, args: i });
          });
        }
        handleMessage(m) {
          !m ||
        ...
        _handleMessage(m) {
          ...
          this._handler.handleMessage(i.method, i.args).then(
            (S) => {
              this._send({ vsWorker: this._workerId, seq: s, res: S, err: void 0 });
            },
            (S) => {
              S.detail instanceof Error && (S.detail = E.transformErrorForSerialization(S.detail)),
                this._send({
      ...
      class L extends M.Disposable {
        constructor(m, i, s) {
          ...
          let S = null;
          typeof self.require != 'undefined' && typeof self.require.getConfig == 'function'
            ? (S = self.require.getConfig())
            : typeof self.requirejs != 'undefined' && (S = self.requirejs.s.contexts._.config);
      ...
      class a {
        ...
        _handleMessage(m, i) {
          ...
          if (!this._requestHandler || typeof this._requestHandler[m] != 'function')
            return Promise.reject(new Error('Missing requestHandler or method: ' + m));
          try {
            return Promise.resolve(this._requestHandler[m].apply(this._requestHandler, i));
          } catch (s) {
          ...
          return this._requestHandlerFactory
            ...
            : (i &&
                ...
                typeof i.paths != 'undefined' &&
                  ...
                  delete i.paths.vs,
                typeof i.trustedTypesPolicy !== void 0 && delete i.trustedTypesPolicy,
                (i.catchError = !0),
              ...
              new Promise((r, c) => {
                self.require(
                  [s],
                  (C) => {
                    if (((this._requestHandler = C.create(n)), !this._requestHandler)) {
    ...
    z(G[22], Q([0, 1, 12]), function (I, t, E) {
      ...
      class M {
        ...
        get(h) {
          return h >= 0 && h < 256 ? this._asciiMap[h] : this._map.get(h) || this._defaultValue;
        }
      }
    ...
    z(G[3], Q([0, 1]), function (I, t) {
      ...
      class E {
        ...
        with(p = this.lineNumber, o = this.column) {
          return p === this.lineNumber && o === this.column ? this : new E(p, o);
        }
        delta(p = 0, o = 0) {
        ...
        static equals(p, o) {
          return !p && !o
            ? !0
            : !!p && !!o && p.lineNumber === o.lineNumber && p.column === o.column;
        }
        isBefore(p) {
        ...
        static isIPosition(p) {
          return p && typeof p.lineNumber == 'number' && typeof p.column == 'number';
        }
      }
      t.Position = E;
    }),
    z(G[6], Q([0, 1, 3]), function (I, t, E) {
      ...
      class M {
        ...
        static isEmpty(o) {
          return o.startLineNumber === o.endLineNumber && o.startColumn === o.endColumn;
        }
        containsPosition(o) {
        ...
        static containsRange(o, h) {
          return !(
            ...
            (h.startLineNumber === o.startLineNumber && h.startColumn < o.startColumn) ||
        ...
        static plusRange(o, h) {
          ...
          return (
            h.startLineNumber < o.startLineNumber
              ...
              : h.startLineNumber === o.startLineNumber
              ? ((u = h.startLineNumber), (l = Math.min(h.startColumn, o.startColumn)))
              : ((u = o.startLineNumber), (l = o.startColumn)),
            h.endLineNumber > o.endLineNumber
              ? ((f = h.endLineNumber), (L = h.endColumn))
              : h.endLineNumber === o.endLineNumber
              ? ((f = h.endLineNumber), (L = Math.max(h.endColumn, o.endColumn)))
        ...
        static collapseToStart(o) {
          return new M(o.startLineNumber, o.startColumn, o.startLineNumber, o.startColumn);
        }
        static fromPositions(o, h = o) {
          return new M(o.lineNumber, o.column, h.lineNumber, h.column);
        }
        static lift(o) {
          return o ? new M(o.startLineNumber, o.startColumn, o.endLineNumber, o.endColumn) : null;
        }
        static isIRange(o) {
          return (
            o &&
        ...
        static areIntersectingOrTouching(o, h) {
          return !(
            ...
            (o.endLineNumber === h.startLineNumber && o.endColumn < h.startColumn) ||
            h.endLineNumber < o.startLineNumber ||
            (h.endLineNumber === o.startLineNumber && h.endColumn < o.startColumn)
          );
        }
    ...
    z(G[25], Q([0, 1, 10, 5]), function (I, t, E, M) {
      ...
      class h {
        constructor(s) {
          const d = [],
            S = [];
          for (let n = 0, r = s.length; n < r; n++) (d[n] = _(s[n], 1)), (S[n] = g(s[n], 1));
          (this.lines = s), (this._startColumns = d), (this._endColumns = S);
        }
        getElements() {
          const s = [];
          for (let d = 0, S = this.lines.length; d < S; d++)
            s[d] = this.lines[d].substring(this._startColumns[d] - 1, this._endColumns[d] - 1);
          return s;
        }
          ...
          return (
            s.originalLength === 0
              ...
              : ((n = d.getStartLineNumber(s.originalStart)),
                ...
                (c = d.getEndLineNumber(s.originalStart + s.originalLength - 1)),
            ...
            s.modifiedLength === 0
              ...
              : ((b = S.getStartLineNumber(s.modifiedStart)),
                ...
                (w = S.getEndLineNumber(s.modifiedStart + s.modifiedLength - 1)),
      ...
      function f(i) {
        ...
        for (let S = 1, n = i.length; S < n; S++) {
          ...
          Math.min(c, C) < p
            ? ((d.originalLength = r.originalStart + r.originalLength - d.originalStart),
              (d.modifiedLength = r.modifiedStart + r.modifiedLength - d.modifiedStart))
            : (s.push(r), (d = r));
        }
        return s;
      }
          ...
          if (
            (d.originalLength === 0
              ...
              : ((b = S.getStartLineNumber(d.originalStart)),
                (v = S.getEndLineNumber(d.originalStart + d.originalLength - 1))),
            d.modifiedLength === 0
              ? ((w = n.getStartLineNumber(d.modifiedStart) - 1), (N = 0))
              : ((w = n.getStartLineNumber(d.modifiedStart)),
                (N = n.getEndLineNumber(d.modifiedStart + d.modifiedLength - 1))),
            c &&
              d.originalLength > 0 &&
              d.originalLength < 20 &&
              d.modifiedLength > 0 &&
            ...
            const P = S.createCharSequence(
              ...
              U = n.createCharSequence(s, d.modifiedStart, d.modifiedStart + d.modifiedLength - 1);
            let R = o(P, U, r, !0).changes;
            C && (R = f(R)), (y = []);
            for (let q = 0, Y = R.length; q < Y; q++) y.push(l.createFromDiffChange(R[q], P, U));
          }
      ...
      class a {
              ...
              if (y !== P) {
                {
                  ...
                  (U > 1 || R > 1) &&
                    this._pushTrimWhitespaceCharChange(n, r + 1, 1, U, c + 1, 1, R);
                }
                {
                  let U = g(y, 1),
                    R = g(P, 1);
                  ...
                  (U < q || R < Y) &&
                    this._pushTrimWhitespaceCharChange(n, r + 1, U, q, c + 1, R, Y);
                }
              }
              r++, c++;
            }
        ...
        _pushTrimWhitespaceCharChange(s, d, S, n, r, c, C) {
          ...
          let b;
          this.shouldComputeCharChanges && (b = [new l(d, S, d, n, r, c, r, C)]),
        ...
        _mergeTrimWhitespaceCharChange(s, d, S, n, r, c, C) {
          ...
          return v.originalEndLineNumber === 0 || v.modifiedEndLineNumber === 0
            ? !1
            : v.originalEndLineNumber + 1 === d && v.modifiedEndLineNumber + 1 === r
    ...
    z(G[26], Q([0, 1]), function (I, t) {
      ...
      function E(u = '') {
        let l = '(-?\\d*\\.\\d\\w*)|([^';
        for (const f of t.USUAL_WORD_SEPARATORS) u.indexOf(f) >= 0 || (l += '\\' + f);
      ...
      function o(u, l, f, L, a = p) {
        if (f.length > a.maxLen) {
          let s = u - a.maxLen / 2;
          return (
            s < 0 ? (s = 0) : (L += s), (f = f.substring(s, u + a.maxLen / 2)), o(u, l, f, L, a)
          );
        }
        const _ = Date.now(),
          g = u - 1 - L;
    ...
    z(G[27], Q([0, 1, 22]), function (I, t, E) {
        ...
        static _createLink(_, g, m, i, s) {
          ...
          if (i > 0) {
            const S = g.charCodeAt(i - 1),
              n = g.charCodeAt(d);
            ((S === 40 && n === 41) || (S === 91 && n === 93) || (S === 123 && n === 125)) && d--;
          }
          return {
            range: { startLineNumber: m, startColumn: i + 1, endLineNumber: m, endColumn: d + 2 },
          ...
          for (let s = 1, d = _.getLineCount(); s <= d; s++) {
            ...
            for (; r < n; ) {
              ...
              if (b === 13) {
                ...
                let R;
                U === 91 ? ((w = !0), (R = 0)) : (R = m.get(U)), R === 1 ? (P = !0) : (b = 13);
              } else (b = g.nextState(b, U)), b === 0 && (P = !0);
              P && ((b = 1), (v = !1), (w = !1), (y = !1), (c = r + 1), (C = U)), r++;
            }
      ...
      t.LinkComputer = f;
      function L(a) {
        return !a || typeof a.getLineCount != 'function' || typeof a.getLineContent != 'function'
          ? []
          : f.computeLinks(a);
      }
      t.computeLinks = L;
    ...
    z(G[28], Q([0, 1]), function (I, t) {
      ...
      class E {
        ...
        valueSetReplace(p, o, h) {
          let u = p.indexOf(o);
          return u >= 0
            ? ((u += h ? 1 : -1), u < 0 ? (u = p.length - 1) : (u %= p.length), p[u])
            : null;
        }
      }
    ...
    z(G[29], Q([0, 1]), function (I, t) {
      ...
      })((M = t.CompletionItemInsertTextRule || (t.CompletionItemInsertTextRule = {})));
      var p;
      (function (e) {
        (e[(e.Method = 0)] = 'Method'),
      ...
      })((u = t.ContentWidgetPositionPreference || (t.ContentWidgetPositionPreference = {})));
      var l;
      (function (e) {
        (e[(e.NotSet = 0)] = 'NotSet'),
      ...
      (function (e) {
        (e[(e.acceptSuggestionOnCommitCharacter = 0)] = 'acceptSuggestionOnCommitCharacter'),
          ...
          (e[(e.copyWithSyntaxHighlighting = 19)] = 'copyWithSyntaxHighlighting'),
          (e[(e.cursorBlinking = 20)] = 'cursorBlinking'),
          (e[(e.cursorSmoothCaretAnimation = 21)] = 'cursorSmoothCaretAnimation'),
          (e[(e.cursorStyle = 22)] = 'cursorStyle'),
          (e[(e.cursorSurroundingLines = 23)] = 'cursorSurroundingLines'),
          (e[(e.cursorSurroundingLinesStyle = 24)] = 'cursorSurroundingLinesStyle'),
          (e[(e.cursorWidth = 25)] = 'cursorWidth'),
          (e[(e.disableLayerHinting = 26)] = 'disableLayerHinting'),
          (e[(e.disableMonospaceOptimizations = 27)] = 'disableMonospaceOptimizations'),
          ...
          (e[(e.unfoldOnClickAfterEndOfLine = 38)] = 'unfoldOnClickAfterEndOfLine'),
          ...
          (e[(e.highlightActiveIndentGuide = 49)] = 'highlightActiveIndentGuide'),
          (e[(e.hover = 50)] = 'hover'),
          ...
          (e[(e.mouseWheelScrollSensitivity = 64)] = 'mouseWheelScrollSensitivity'),
          (e[(e.mouseWheelZoom = 65)] = 'mouseWheelZoom'),
          (e[(e.multiCursorMergeOverlapping = 66)] = 'multiCursorMergeOverlapping'),
          ...
          (e[(e.renderLineHighlightOnlyWhenFocus = 84)] = 'renderLineHighlightOnlyWhenFocus'),
          (e[(e.renderValidationDecorations = 85)] = 'renderValidationDecorations'),
          (e[(e.renderWhitespace = 86)] = 'renderWhitespace'),
          (e[(e.revealHorizontalRightPadding = 87)] = 'revealHorizontalRightPadding'),
          ...
          (e[(e.suggestOnTriggerCharacters = 107)] = 'suggestOnTriggerCharacters'),
          ...
          (e[(e.wordWrapBreakAfterCharacters = 116)] = 'wordWrapBreakAfterCharacters'),
          (e[(e.wordWrapBreakBeforeCharacters = 117)] = 'wordWrapBreakBeforeCharacters'),
      ...
      })((d = t.InlineCompletionTriggerKind || (t.InlineCompletionTriggerKind = {})));
      var S;
      (function (e) {
      ...
      })((b = t.OverlayWidgetPositionPreference || (t.OverlayWidgetPositionPreference = {})));
      var v;
      (function (e) {
        (e[(e.Left = 1)] = 'Left'),
          (e[(e.Center = 2)] = 'Center'),
      ...
      (function (e) {
        (e[(e.Hidden = 0)] = 'Hidden'),
          ...
          (e[(e.Expand = 4)] = 'Expand'),
          (e[(e.Solid = 5)] = 'Solid');
      })((j = t.TextEditorCursorBlinkingStyle || (t.TextEditorCursorBlinkingStyle = {})));
      var T;
      (function (e) {
        (e[(e.Line = 1)] = 'Line'),
          (e[(e.Block = 2)] = 'Block'),
    ...
    z(
      G[30],
      Q([0, 1, 20, 9, 16, 13, 3, 6, 23, 24, 29]),
      function (I, t, E, M, p, o, h, u, l, f, L) {
        'use strict';
        Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    z(G[31], Q([0, 1, 12]), function (I, t, E) {
      ...
      class p {
          ...
          return L === 0
            ...
            : ((this.values = new Uint32Array(l.length + L)),
              ...
              this.prefixSumValidIndex[0] >= 0 &&
                this.prefixSum.set(f.subarray(0, this.prefixSumValidIndex[0] + 1)),
              !0);
        }
        changeValue(h, u) {
          return (
        ...
        getAccumulatedValue(h) {
          return h < 0 ? 0 : ((h = E.toUint32(h)), this._getAccumulatedValue(h));
        }
        _getAccumulatedValue(h) {
          ...
          for (let l = u; l <= h; l++) this.prefixSum[l] = this.prefixSum[l - 1] + this.values[l];
          return (
    ...
    z(G[32], Q([0, 1, 5, 3, 31]), function (I, t, E, M, p) {
      ...
      class o {
        ...
        _setLineText(u, l) {
          (this._lines[u] = l),
            this._lineStarts &&
              this._lineStarts.changeValue(u, this._lines[u].length + this._eol.length);
        }
        _acceptDeleteRange(u) {
          ...
          this._setLineText(
            ...
            this._lines.splice(u.startLineNumber, u.endLineNumber - u.startLineNumber),
            this._lineStarts &&
              this._lineStarts.removeValues(u.startLineNumber, u.endLineNumber - u.startLineNumber);
        }
        _acceptInsertText(u, l) {
          ...
          (f[f.length - 1] += this._lines[u.lineNumber - 1].substring(u.column - 1)),
            this._setLineText(
              u.lineNumber - 1,
  ...
  z(
    G[34],
    Q([0, 1, 10, 2, 13, 3, 6, 25, 32, 26, 27, 28, 30, 11, 8]),
    function (I, t, E, M, p, o, h, u, l, f, L, a, _, g, m) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      class i extends l.MirrorTextModel {
        ...
        getWordAtPosition(n, r) {
          ...
          return c ? new h.Range(n.lineNumber, c.startColumn, n.lineNumber, c.endColumn) : null;
        }
        words(n) {
          const r = this._lines,
            ...
            *[Symbol.iterator]() {
              for (;;)
                if (v < w.length) {
                  ...
                  (v += 1), yield N;
                } else if (C < r.length) (b = r[C]), (w = c(b, n)), (v = 0), (C += 1);
                else break;
            },
          };
        }
        ...
        getValueInRange(n) {
          if (((n = this._validateRange(n)), n.startLineNumber === n.endLineNumber))
            return this._lines[n.startLineNumber - 1].substring(n.startColumn - 1, n.endColumn - 1);
          let r = this._eol,
        ...
        offsetAt(n) {
          return (
            ...
            this._lineStarts.getAccumulatedValue(n.lineNumber - 2) + (n.column - 1)
          );
        }
        positionAt(n) {
          ...
          return { lineNumber: 1 + r.index, column: 1 + Math.min(r.remainder, c) };
        }
        _validateRange(n) {
        ...
        _validatePosition(n) {
          ...
          if (r < 1) (r = 1), (c = 1), (C = !0);
            ...
            (r = this._lines.length), (c = this._lines[r - 1].length + 1), (C = !0);
          else {
      ...
      class s {
        ...
        _getModels() {
          let n = [];
          return Object.keys(this._models).forEach((r) => n.push(this._models[r])), n;
        }
        acceptNewModel(n) {
          this._models[n.url] = new i(p.URI.parse(n.url), n.lines, n.EOL, n.versionId);
        }
        ...
        computeMoreMinimalEdits(n, r) {
          return ie(this, void 0, void 0, function* () {
            ...
            r = r.slice(0).sort((v, w) => {
              if (v.range && w.range) return h.Range.compareRangesUsingStarts(v.range, w.range);
              let N = v.range ? 0 : 1,
                y = w.range ? 0 : 1;
              return N - y;
            });
            for (let { range: v, text: w, eol: N } of r) {
              if ((typeof N == 'number' && (b = N), h.Range.isEmpty(v) && !w)) continue;
            ...
            e: for (let N of n) {
              ...
              if (!!y) {
                for (let P of y.words(v))
                  if (!(P === r || !isNaN(Number(P))) && (w.add(P), w.size > s._suggestionsLimit))
                    break e;
              }
            }
        ...
        navigateValueSet(n, r, c, C, b) {
          return ie(this, void 0, void 0, function* () {
            ...
            let N = v.getValueInRange(r),
              y = v.getWordAtPosition({ lineNumber: r.startLineNumber, column: r.startColumn }, w);
            if (!y) return null;
        ...
        loadForeignModule(n, r, c) {
          ...
          let v = { host: g.createProxyObject(c, C), getMirrorModels: () => this._getModels() };
        ...
        fmr(n, r) {
          ...
          try {
            return Promise.resolve(this._foreignModule[n].apply(this._foreignModule, r));
          } catch (c) {
            return Promise.reject(c);
          }
        }
      }
      (t.EditorSimpleWorker = s), (s._diffLimit = 1e5), (s._suggestionsLimit = 1e4);
      function d(S) {
        return new s(S, null);
      }
      (t.create = d),
        typeof importScripts == 'function' && (M.globals.monaco = _.createMonacoBaseAPI());
    }
  ),
    (function () {
      var I, t;
      const E = self.MonacoEnvironment,
        ...
        p =
          typeof ((I = self.trustedTypes) === null || I === void 0 ? void 0 : I.createPolicy) ==
          'function'
          ...
          if (
            ...
            fetch(a)
              ...
              .then((g) => {
                (g = `${g}
//# sourceURL=${a}`),
                  (p ? self.eval(p.createScript('', g)) : new Function(g)).call(self),
                  f();
              })
              .then(void 0, L);
            return;
